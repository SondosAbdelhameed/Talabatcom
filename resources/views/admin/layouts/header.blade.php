        ...
        <hr>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">الرئيسية</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('clientslist.index')}}">
              ...
              <i class="align-middle" data-feather="coffee"></i> <span class="align-middle">إدارة المطاعم</span>
            </a>
					</li>
          ...
          <li class="sidebar-item">
              ...
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">إدارة الأقسام</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('menuCategory.index')}}">
							<i class="align-middle" data-feather="grid"></i> <span class="align-middle">إدارة اقسام المنيو</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('cms.index')}}">
							<i class="align-middle" data-feather="grid"></i> <span class="align-middle">إدارة المحتوي</span>
						</a>
					</li>
					<li class="sidebar-item">
